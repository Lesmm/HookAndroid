...
public class IMonitoringFileUtil {

	public static final String SDCardPath = "/sdcard/";
	public static final String DataLocalTmpPath = "/data/local/tmp";
	public static final String ExternalStoragePath = Environment.getExternalStorageDirectory().getAbsolutePath();

	public static boolean isInMonitoringPath(String path) {
		String slashedPath = __fixSlashes__(path);
		return path.contains(ExternalStoragePath) || path.startsWith(SDCardPath) || path.startsWith(DataLocalTmpPath) 
				|| slashedPath.contains(ExternalStoragePath) || slashedPath.startsWith(SDCardPath) || slashedPath.startsWith(DataLocalTmpPath) ;
	}

	public static void storeWriteMonitoringPathLog(String logFileName, String slashedPath) {
